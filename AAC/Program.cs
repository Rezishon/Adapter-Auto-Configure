        ...
        static void Main(string[] args)
        {
            ...
            while (flag)
            {
                ...
                switch (number)
                {
                    ...
                    case 2:
                        RunCommand(
                            "netsh interface ipv4 set address name=\"Wi-Fi\" static 192.168.1.100 255.255.255.0 192.168.1.1; netsh interface ipv4 set dns name=\"Wi-Fi\" static 8.8.8.8; netsh interface ipv4 add dns name=\"Wi-Fi\" 4.2.2.4 index=2;"
                        );
                        break;
                    case 3:
                        RunCommand(
                            "netsh interface ipv4 set address name=\"Wi-Fi\" static 192.168.85.62 255.255.255.0 192.168.85.1; netsh interface ipv4 set dns name=\"Wi-Fi\" static 8.8.8.8; netsh interface ipv4 add dns name=\"Wi-Fi\" 4.2.2.4 index=2;"
                        );
                        break;
                    case 4:
                        RunCommand(
                            "netsh interface ipv4 set address name=\"Ethernet\" static 192.168.85.61 255.255.255.0 192.168.85.1; netsh interface ipv4 set dns name=\"Ethernet\" static 8.8.8.8; netsh interface ipv4 add dns name=\"Ethernet\" 4.2.2.4 index=2;"
                        );
                        break;
                    case 5:
                        RunCommand(
                    ...
                    case 6:
                        RunCommand(
                            "netsh interface ipv4 set dns name=\"Wi-Fi\" static 185.51.200.2; netsh interface ipv4 add dns name=\"Wi-Fi\" 178.22.122.100 index=2;"
                        );
                        break;
                    case 7:
                        RunCommand(
                            "netsh interface ipv4 set dns name=\"Ethernet\" static 185.51.200.2; netsh interface ipv4 add dns name=\"Ethernet\" 178.22.122.100 index=2;"
                        );
                        break;
                    case 8:
                        RunCommand(
                            "netsh interface ipv4 set dns name=\"Wi-Fi\" static 8.8.8.8; netsh interface ipv4 add dns name=\"Wi-Fi\" 4.2.2.4 index=2;"
                        );
                        break;
                    case 9:
                        RunCommand(
                            "netsh interface ipv4 set dns name=\"Ethernet\" static 8.8.8.8; netsh interface ipv4 add dns name=\"Ethernet\" 4.2.2.4 index=2;"
                        );
                        break;
                    case 10:
                        RunCommand("ipconfig /flushdns; ipconfig /release; ipconfig /renew");
                        break;
                    case 11:
                        RunCommand(
                            "ping -a -n 2 soft98.ir; echo \" \" \"press any key to exit\"; $null = $Host.UI.RawUI.ReadKey('NoEcho,IncludeKeyDown');"
                        );
                        break;
                    case 12:
                        RunCommand(
                            "ping -a -n 2 youtube.com; echo \" \" \"press any key to exit\"; $null = $Host.UI.RawUI.ReadKey('NoEcho,IncludeKeyDown');"
                        );
                        break;
                }
                Console.Clear();
